! function(d) {
    ...
    window.qodefAddonsCore = {}, qodefAddonsCore.shortcodes = {}, qodefAddonsCore.body = d("body"), qodefAddonsCore.html = d("html"), qodefAddonsCore.windowWidth = d(window).width(), qodefAddonsCore.windowHeight = d(window).height(), qodefAddonsCore.scroll = 0, d(document).ready(function() {
        qodefAddonsCore.scroll = d(window).scrollTop(), C.init(), e.init()
    ...
    var C = {
        ...
        initSlider: function(o) {
            ...
            elementorFrontend.config.experimentalFeatures.e_optimized_assets_loading ? t = setInterval(function() {
                if ("undefined" !== elementorFrontend.utils.swiper) {
                    ...
                    new e(o, Object.assign(n, d)).then(e => {}), clearInterval(t)
                }
            }, 200) : new Swiper(o, Object.assign(n, d))
        },
        getOptions: function(e) {
            var o = void 0 !== e.data("options") ? e.data("options") : {},
                ...
                _ = void 0 !== o.outsideNavigation && "yes" === o.outsideNavigation,
                m = _ ? ".swiper-button-next-" + o.unique : e.find(".swiper-button-next"),
                p = _ ? ".swiper-button-prev-" + o.unique : e.find(".swiper-button-prev"),
            ...
            var v = void 0 !== o.slidesPerView1440 && "" !== o.slidesPerView1440 ? parseInt(o.slidesPerView1440, 10) + t : "auto" === o.slidesPerView ? "auto" : 5 + t,
                ...
                _ = void 0 !== o.slidesPerView768 && "" !== o.slidesPerView768 ? parseInt(o.slidesPerView768, 10) + t : "auto" === o.slidesPerView ? "auto" : 2 + t,
            ...
            return q || (r < 2 ? _ = b = w = v = r : r < 3 ? b = w = v = r : r < 4 ? w = v = r : r < 5 && (v = r)), Object.assign({
                slidesPerView: r,
                centeredSlides: a,
                sliderScroll: s,
                loopedSlides: "12",
...
function(e) {
    ...
    var s = {
        ...
        sliderLoop: function(t, e) {
            ...
            }), i.on("click", a), r.on("click", function() {
                var e = d.last(),
                    o = d.first();
    ...
    var o = {
        ...
        generateChartData: function(d) {
            var e = (e = d.data("type")) ? "pie" : "doughnut",
                ...
                _ = d.data("legend-bar-margin"),
                m = d.data("legend-label-color"),
            ...
            d.addClass("qodef--init"), C.forEach(function(e, t) {
                ...
                e && (y = !0, (n = new Image).src = C[t], n.onload = function() {
                    ...
                    i[t] = o, r[t] = o, A = new Chart(e, I)
                })
            }), y || (w = d.find("canvas"), A = new Chart(w, I))
        }
    };
    ...
    var n = {
        ...
        generateChartData: function(e, o) {
            ...
            return r.forEach(function(e, o) {
                var t = {};
                t.data = r[o].split(","), t.label = a[o], t.backgroundColor = l[o], t.hoverBackgroundColor = f[o], t.borderColor = c[o], t.hoverBorderColor = h[o], t.borderWidth = u, t.hoverBorderWidth = q, t.pointBackgroundColor = "rgba(0,0,0,0)", t.pointBorderColor = "rgba(0,0,0,0)", t.pointHoverBackgroundColor = "rgba(0,0,0,0)", t.pointHoverBorderColor = "rgba(0,0,0,0)", t.cubicInterpolationMode = "default", t.fill = d[o], t.barPercentage = _, t.categoryPercentage = m, t.tension = i[o], x.push(t)
...
function(d) {
    ...
    var e = {
        init: function() {
            this.holder = d(".qodef-qi-interactive-link-showcase"), this.holder.length && this.holder.each(function() {
                e.initItem(d(this))
            })
        },
        initItem: function(e) {
    ...
    var o = {
        ...
        initItem: function(e) {
            var o, t = e.find(".qodef-m-main-slider > .qodef-qi-swiper-container .swiper-slide-active"),
                ...
                d = e.find(".qodef-m-main-slider > .qodef-qi-swiper-container"),
                i = e.find(".qodef-slider-switch-device-holder .qodef-qi-swiper-container"),
                r = e.find(".qodef-m-main-text .qodef-qi-swiper-container");
            n.width(t.width()), n.css("top", t.height()), a = d.find(".swiper-slide").length, (o = i[0].swiper.params).loopedSlides = a, o.autoplay = !1, (n = r[0].swiper.params).grabCursor = !1, n.loopedSlides = a, n.autoplay = !1, n.effect = "fade", n.allowTouchMove = !1, r[0].swiper.update();
            var t = i.data().options.autoplayDelay,
                a = d[0].swiper.autoplay.running;
            d[0].swiper.autoplay.stop(), i[0].swiper.destroy(), r[0].swiper.destroy();
            let s = new Swiper(i, Object.assign(o)),
                l = new Swiper(r, Object.assign(n));
            d[0].swiper.controller.control = s, d[0].swiper.controller.by = "slide", d[0].swiper.controller.inverse = !0, s.controller.control = d[0].swiper, a && ("" != t ? setTimeout(function() {
                d[0].swiper.autoplay.start()
            }, t) : d[0].swiper.autoplay.start()), e.addClass("qodef--visible"), s.on("slideChange", function() {
                var e = s.realIndex;
...
function(d) {
    ...
    var e = {
        init: function() {
            this.holder = d(".qodef-qi-typeout-text"), this.holder.length && this.holder.each(function() {
                e.initItem(d(this))
            })
        },
        initItem: function(e) {
...
function(n) {
    ...
    qodefAddonsCore.shortcodes[e].qodefLightboxPopup = qodefAddonsCore.qodefLightboxPopup, qodefAddonsCore.shortcodes[e].qodefMasonryLayout = qodefAddonsCore.qodefMasonryLayout, qodefAddonsCore.shortcodes[e].qodefAddonsCoreResizeIframes = o, qodefAddonsCore.shortcodes[e].qodefButton = qodefAddonsCore.qodefButton
}(jQuery),
function() {
    "use strict";
            ...
            e.length && e.each(function() {
                ...
                e.on("click", function(e) {
                    e.preventDefault(), n.ajax({
                        ...
                        url: ajaxurl,
                        success: function(e) {
                            "success" === n.parseJSON(e).status && d.noticeHolder.slideUp("fast")
                        }
                    })
                })
            })
...
! function(e) {
    ...
    var u, r, v = {
        ...
        p = function(e, t, n, o) {
            ...
            n.pX = u, n.pY = r, n.timeoutId = setTimeout(function() {
                p(e, t, n, o)
            }, o.interval)
        };
    i.fn.hoverIntent = function(e, t, n) {
        var o = a++,
            s = i.extend({}, v);
        i.isPlainObject(e) ? (s = i.extend(s, e), i.isFunction(s.out) || (s.out = s.over)) : s = i.isFunction(t) ? i.extend(s, {
            over: e,
            out: t,
            selector: n
        }) : i.extend(s, {
        ...
        t = function(e) {
            ...
            "mouseenter" === e.type ? v.isActive || (v.pX = u.pageX, v.pY = u.pageY, r.off(t, d).on(t, d), v.timeoutId = setTimeout(function() {
                p(u, r, v, s)
            }, s.interval)) : v.isActive && (r.off(t, d), v.timeoutId = setTimeout(function() {
                var e, t, n, o, i;
