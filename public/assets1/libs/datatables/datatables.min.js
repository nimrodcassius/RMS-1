...
(function(e) {
    ...
    var j = e.fn.dataTable,
        ...
        p = j.ext.buttons,
        o = function(a, b) {
            if (!(this instanceof o)) return function(b) {
    ...
    e.extend(o.prototype, {
        ...
        _expandButton: function(a, b, c, d) {
            for (var f =
                    this.s.dt, h = 0, b = !Array.isArray(b) ? [b] : b, i = 0, k = b.length; i < k; i++) {
                var m = this._resolveExtends(b[i]);
                if (m)
                    if (Array.isArray(m)) this._expandButton(a, m, c, d);
                    else {
                        var g = this._buildButton(m, c);
                        g && (d !== l && null !== d ? (a.splice(d, 0, g), d++) : a.push(g), g.conf.buttons && (g.collection = e("<" + this.c.dom.collection.tag + "/>"), g.conf._collection = g.collection, this._expandButton(g.buttons, g.conf.buttons, !0, d)), m.init && m.init.call(f.button(g.node), f, e(g.node), m), h++)
                    }
            }
        },
        _buildButton: function(a, b) {
            ...
            var k = function(a, b, c, d) {
                ...
                g = e("<" + f + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb",
                    function(b) {
                        b.preventDefault();
            ...
            d.tag ? (f = e("<" + d.tag + "/>").html(i(a.text)).addClass(d.className), "a" === d.tag.toLowerCase() && f.attr("href", "#"), g.append(f)) : g.html(i(a.text));
        ...
        _popover: function(a, b, c) {
            ...
            c.length && (h = c.eq(0), i());
            c = e("<div/>").addClass("dt-button-collection").addClass(f.collectionLayout).css("display",
                "none");
            ...
            if ("absolute" === k) {
                ...
                var k = d.offset().left,
                    ...
                    n = h.outerWidth(),
                    l = j + n;
                c.hasClass(f.rightAlignClassName) || c.hasClass(f.leftAlignClassName) || "dt-container" === f.align ? (n = 0, c.hasClass(f.rightAlignClassName) ? (n = l - g, k > m + n && (k -= m + n, d -= g + n, n = k > d ? n + d : n + k)) : (n = k - m, d < g + n && (k -= m + n, d -= g + n, n = k > d ? n + d : n + k))) : (d =
                    h.offset().top, n = 0, n = "button-right" === f.align ? l - g : j - m);
            ...
            e("body").on("click.dtb-collection", function(b) {
                ...
                (!e(b.target).parents()[c]().filter(a).length && !e(d).hasClass("dt-buttons") || e(b.target).hasClass("dt-button-background")) &&
                i()
    ...
    o.instanceSelector = function(a, b) {
        if (a === l || null === a) return e.map(b, function(a) {
            return a.inst
        });
        var c = [],
    ...
    o.buttonSelector = function(a, b) {
        for (var c = [], d = function(a, b, c) {
                ...
                if (Array.isArray(a) || a instanceof e) {
                    ...
                    } else if (a.match(/^\d+(\-\d+)*$/)) g = e.map(i, function(a) {
                    return a.idx
                }), c.push({
                    inst: b,
                    node: i[e.inArray(a,
                    ...
                    g = 0;
                    for (h = i.length; g < h; g++) i[g].name === j && c.push({
                        inst: b,
                        node: i[g].node
                    })
                ...
                else "object" === typeof a && a.nodeName && (i = e.inArray(a, g), -1 !== i && c.push({
                    inst: b,
                    node: g[i]
                }))
            }, h = 0, i = a.length; h < i; h++) f(b, a[h]);
        return c
    };
    ...
    j.Api.register("buttons().containers()", function() {
        ...
        this.iterator(!0, "table", function(c) {
            if (c._buttons)
                for (var c = o.instanceSelector(b, c._buttons), d = 0, e = c.length; d < e; d++) a = a.add(c[d].container())
        });
        return a
    });
    ...
    j.Api.register("button().add()", function(a,
        b) {
        var c = this.context;
    ...
    j.Api.register("buttons.exportData()", function(a) {
        if (this.context.length) {
            ...
            b.select && "function" === typeof b.select.info && f.selected === l && b.rows(c.rows, e.extend({
                selected: !0
            }, f)).any() && e.extend(f, {
                selected: !0
            });
            for (var f = b.rows(c.rows, f).indexes().toArray(), h = b.cells(f, c.columns), f = h.render(c.orthogonal).toArray(), h = h.nodes().toArray(), i = a.length,
                    k = [], m = 0, g = 0, q = 0 < i ? f.length / i : 0; g < q; g++) {
    ...
    j.Api.register("buttons.exportInfo()", function(a) {
        ...
        b === l || null === b ? b = null : (-1 !== b.indexOf("*") && (b = b.replace("*", e("head > title").text()).trim()), b = b.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g,
            ""), (c = v(c.extension)) || (c = ""), b += c);
        c = v(a.title);
